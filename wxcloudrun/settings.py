...
if mysql_address and os.environ.get("MYSQL_USERNAME"):
    DATABASES = {
        'default': {
            ...
            'PORT': mysql_address.split(':')[1] if ':' in mysql_address else '3306',
...
ADMIN_PASSWORD = os.environ.get('ADMIN_PASSWORD', 'xueba-admin')
